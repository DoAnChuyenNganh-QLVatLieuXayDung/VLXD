...
namespace VatLieuXayDung.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult ShowAllSanPham(int? page)
        {
            ...
            Session["clh"] = db.HoaDons.Where(t => t.KhachHang.TenKH == user && t.TrangThaiDonHang == "Chờ lấy hàng").Count();
            Session["dgh"] = db.HoaDons.Where(t => t.KhachHang.TenKH == user && t.TrangThaiDonHang == "Đang giao hàng").Count();
