...
namespace BLL_DAL
{
	...
	public partial class QL_VatLieuXayDungDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTinTuc(TinTuc instance);
		...
		public QL_VatLieuXayDungDataContext() : 
				base(global::BLL_DAL.Properties.Settings.Default.QL_VatLieuXayDungConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public QL_VatLieuXayDungDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QL_VatLieuXayDungDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QL_VatLieuXayDungDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QL_VatLieuXayDungDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnYeuThichChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ThongTin", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
